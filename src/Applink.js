  ...
  return (
    <div className="Applink">
      ...
      <img onClick = {handleClickhome} src={logo} alt="Silo-logo" className = "logo"/>
                    ...
                    <a className = 'appstorelink' href='https://apps.apple.com/us/app/silo-pods/id1604451202'>
                <img className = 'appstore' alt='Get Silo on the App Store' src={Appstore}/>
            </a>
            <a className = 'googleplaylink' href='https://play.google.com/store/apps/details?id=com.silo&pcampaignid=pcampaignidMKT-Other-global-all-co-prtnr-py-PartBadge-Mar2515-1'>
